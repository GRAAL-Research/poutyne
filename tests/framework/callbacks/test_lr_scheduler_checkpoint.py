...
from pytoune.framework.callbacks import LRSchedulerCheckpoint, CallbackList
...
class OptimizerCheckpointTest(TestCase):
    ...
    def test_any_scheduler_integration(self):
        ...
        self.model.fit_generator(train_gen, valid_gen, epochs=OptimizerCheckpointTest.epochs, steps_per_epoch=5, callbacks=[checkpointer])
