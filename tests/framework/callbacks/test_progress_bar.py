...
class ProgressBarTest(TestCase):
    ...
    def test_default_bar_character_is_properly_step(self):
        ...
        progress_bar = ProgressBar(steps=smaller_bar_length, bar_length=ProgressBarTest.BAR_LENGTH, bar_character="#")
    ...
    def test_bar_formatting_steps_equal_to_bar_length(self):
        ...
        progress_bar = ProgressBar(steps=equal_bar_length, bar_length=ProgressBarTest.BAR_LENGTH, bar_character="#")
    ...
    def test_bar_formatting_steps_greater_than_bar_length(self):
        ...
        progress_bar = ProgressBar(steps=greater_bar_length, bar_length=ProgressBarTest.BAR_LENGTH, bar_character="#")
    ...
    def test_bar_formatting_steps_greaterodd_than_bar_length(self):
        steps = 111
        bar_length = 25
        progress_bar = ProgressBar(steps=steps, bar_length=bar_length, bar_character="#")
    ...
    def test_last_step_is_correctly_formatted(self):
        for steps in range(1, 200):
            progress_bar = ProgressBar(steps=steps, bar_length=ProgressBarTest.BAR_LENGTH, bar_character="#")
